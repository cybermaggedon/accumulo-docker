...
```
  ...
  docker run -d --ip=10.10.10.10 --net my_network \
      ...
      --name acc01 cybermaggedon/accumulo:1.9.3
...
```
  ...
  docker run -d --ip=10.10.10.10 --net my_network \
      ...
      --link hadoop01:hadoop01 \
      --name acc-master cybermaggedon/accumulo:1.9.3 /start-process master
  ...
  docker run -d --ip=10.10.10.11 --net my_network \
      ...
      -e TRACER_HOSTS=10.10.10.16 \
      --link hadoop01:hadoop01 \
      --name acc-gc cybermaggedon/accumulo:1.9.3 /start-process gc
  ...
  docker run -d --ip=10.10.10.12 --net my_network \
      ...
      -e TRACER_HOSTS=10.10.10.16 \
      --link hadoop01:hadoop01 \
      --name acc-slave1 cybermaggedon/accumulo:1.9.3 /start-process tserver
  ...
  docker run -d --ip=10.10.10.13 --net my_network \
      ...
      -e TRACER_HOSTS=10.10.10.16 \
      --link hadoop01:hadoop01 \
      --name acc-slave2 cybermaggedon/accumulo:1.9.3 /start-process tserver
  ...
  docker run -d --ip=10.10.10.14 --net my_network \
      ...
      -e TRACER_HOSTS=10.10.10.16 \
      --link hadoop01:hadoop01 \
      --name acc-slave3 cybermaggedon/accumulo:1.9.3 /start-process tserver
  ...
  docker run -d --ip=10.10.10.15 --net my_network \
      ...
      -e TRACER_HOSTS=10.10.10.16 \
      --link hadoop01:hadoop01 \
      --name acc-monitor cybermaggedon/accumulo:1.9.3 /start-process monitor
  ...
  docker run -d --ip=10.10.10.16 --net my_network \
      ...
      -e TRACER_HOSTS=10.10.10.16 \
      --link hadoop01:hadoop01 \
      --name acc-tracer cybermaggedon/accumulo:1.9.3 /start-process tracer
